...
resource "aws_lambda_function" "check_user_email" {
  ...
  # (opcional) caso use um layer com psycopg2
...
resource "aws_lambda_permission" "allow_apigw" {
  ...
  function_name = aws_lambda_function.check_user_email.function_name
...
resource "aws_apigatewayv2_integration" "lambda_integration" {
  ...
  integration_uri        = aws_lambda_function.check_user_email.invoke_arn
